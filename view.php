...
<?php 
    ...
    if(!isset($_GET['id'])){
        ...
        $id = $_GET['id'];
        $result = $crud->getphotographerDetails($id);
...
<div class="card" style="width: 18rem;">
    ...
    <a href = "edit.php?id=<?php echo $result['photographer_id'] ?>" class="btn btn-warning">Edit</a>
    <a onclick="return confirm('Are you sure you want to delete this record?');"
    href = "delete.php?id=<?php echo $result['photgrapher_id'] ?>" class="btn btn-danger">Delete</a>
<?php } ?>
